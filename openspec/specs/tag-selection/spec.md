# tag-selection Specification

## Purpose

Reusable `TagMultiselect` controlled React component for selecting one or more tags from the registry. Used on resource and document create/edit forms.
